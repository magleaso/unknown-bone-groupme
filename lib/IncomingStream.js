...
IncomingStream.prototype.connect = function(fiddler) {
  if (fiddler) {
    // DANGEROUS! Only do this when debugging with fiddler
  ...
  var requestOptions = {
    agent: fiddler ? tunnelingAgent : undefined
  };
  
  this.client.connect(Constants.WEBSOCKETS_BASEURL, null, null, null, requestOptions);    
};
